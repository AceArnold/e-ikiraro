...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #send OTP email
            _send_otp_email(request, user, form.cleaned_data.get('email'), code)
            ...
            messages.success(request, f'Account created for {username}! A verification code was sent to your email.')
...
@login_required
def profile(request):
    return render(request, 'users/profile.html', {'title': 'Login'})
