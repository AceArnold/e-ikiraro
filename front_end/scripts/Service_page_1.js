document.getElementById("provisional-btn").addEventListener("click", function() {
  window.location.href = "./register-id.html"; // or create a new dedicated provisional page
});
...
document.getElementById("practical-btn").addEventListener("click", function() {
  ...
  if (code && code.trim().length >= 5) {
    ...
    window.location.href = "./register-id.html"; // can later point to a 'practical-registration.html'
  } else {
